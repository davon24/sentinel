...
taking a small sample to build a data set for our model.   
```  
...
An example of a message in our sample model data that has an error,    
rowid 124,  tag '0'   
```
...
```
sentinel update-model-tag 124 1
```
...
The sentinel program reads in the model data set (sentinel list-model) and displays how many records and how many are tagged as '1'   
```
...
Predictions are in shared_memory and prometheus format
```
sentinel list-keys
```
...
```
sentinel get-key naive_bayes.MultinomialNB-51500ef81e3364556f3578b293b81dfa1c503854
```
```
sentinel_watch_syslog_sklearn{config="watch-syslog-sklearn-1",algo="naive_bayes.MultinomialNB",predict="1",seen="True",b2sum="51500ef81e3364556f3578b293b81dfa1c503854",sample="[Privacy] Did stop advertising with error: (null) Default WirelessProximity "} 295
```
...
```
sentinel get-key naive_bayes.MultinomialNB-f01910b0a4ecd16c2632dcb78cd8f4b0b362ab7b
